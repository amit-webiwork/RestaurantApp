...
function DietaryPreferences({ items, clickHandler, checkboxContainerStyle, checkboxStyle, checkedBoxStyle, labelStyle }: Props): React.JSX.Element {
...
const DietaryPreferencesSection = memo(DietaryPreferences);
